...
const userSchema = new mongoose.Schema({
    ...
    // Ví nội bộ - Internal wallet system
    walletBalance: { type: Number, default: 0, min: 0 }, // Tổng số dư
    reservedBalance: { type: Number, default: 0, min: 0 }, // Số dư đang bị khóa (đấu giá)
